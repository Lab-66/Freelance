...
<ul class="navigation">
    ...
    @if(isset($user_data) && ($user_data->hasAccess(['contacts.read']) || $user_data->inRole('admin')))
        <li {!! (Request::is('customer/*') || Request::is('customer') || Request::is('company/*') || Request::is('company') ? 'class="active"' : '') !!}>
            <a href="{{url('company')}}" onclick="window.location.href='{{url('company')}}'">
            ...
            <ul class="nav-sub">
                ...
                <li {!! (Request::is('customer/*') || Request::is('customer') ? 'class="active"' : '') !!}>
                    <a href="{{url('running_projects')}}">
                        <i class="fa fa-circle-o"></i>
                        <span class="nav-text">{{'Running Projects'}}</span></a>
                </li>
                <li {!! (Request::is('customer/*') || Request::is('customer') ? 'class="active"' : '') !!}>
                    <a href="{{url('notes')}}">
                        <i class="fa fa-circle-o"></i>
                        <span class="nav-text">{{'Note'}}</span></a>
                </li>
                <li {!! (Request::is('customer/*') || Request::is('customer') ? 'class="active"' : '') !!}>
                    <a href="{{url('background_information')}}">
                        <i class="fa fa-circle-o"></i>
                        <span class="nav-text">{{'Background Information'}}</span></a>
                </li>
            </ul>
        </li>
    @endif
    ...
    <li {!! (Request::is('support_ticket/*') || Request::is('support_ticket')  ? 'class="active"' : '') !!}>
        <a>
        <span class="nav-caret pull-right">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
