<div class="panel panel-primary">
    <div class="panel-body">
        @if (isset($saleorder))
            {!! Form::model($saleorder, array('url' => $type . '/' . $saleorder->id, 'method' => 'put', 'files'=> true, 'id'=>'form')) !!}
        @else
        ...
        <div class="form-group required {{ $errors->has('customer_id') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('customer_id', $customers, (isset($saleorder->customer_id)?$saleorder->customer_id:null), array('id'=>'customer_id','class' => 'form-control')) !!}
        ...
        <div class="form-group required {{ $errors->has('qtemplate_id') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('qtemplate_id', $qtemplates, (isset($saleorder)?$saleorder->qtemplate_id:null), array('id'=>'qtemplate_id','class' => 'form-control')) !!}
                ...
                <select name="payment_term" class="form-control">
                    ...
                    @if(Settings::get('payment_term1')!='0')
                        <option value="{{Settings::get('payment_term1')}}"
                            @if(isset($saleorder) && Settings::get('payment_term1') == $saleorder->payment_term) selected @endif>{{Settings::get('payment_term1')}} {{trans('quotation.days')}}</option>
                    @endif
                    @if(Settings::get('payment_term2')!='0')
                        <option value="{{Settings::get('payment_term2')}}"
                                @if(isset($saleorder) && Settings::get('payment_term2') == $saleorder->payment_term) selected @endif>{{Settings::get('payment_term2')}} {{trans('quotation.days')}}</option>
                    @endif
                    @if(Settings::get('payment_term3')!='0')
                        <option value="{{Settings::get('payment_term3')}}"
                                @if(isset($saleorder) && Settings::get('payment_term3') == $saleorder->payment_term) selected @endif>{{Settings::get('payment_term3')}} {{trans('quotation.days')}}</option>
                    @endif
                    <option value="0"
        ...
        <div class="form-group required {{ $errors->has('sales_team_id') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('sales_team_id', $salesteams, (isset($saleorder)?$saleorder->sales_team_id:null), array('id'=>'sales_team_id','class' => 'form-control')) !!}
        ...
        <div class="form-group required {{ $errors->has('sales_person_id') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('sales_person_id', $staffs, (isset($saleorder)?$saleorder->sales_person_id:null), array('id'=>'sales_person_id','class' => 'form-control')) !!}
        ...
        <div class="form-group required {{ $errors->has('status') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('status', $statuses, (isset($saleorder)?$saleorder->status:null), array('id'=>'status','class' => 'form-control')) !!}
