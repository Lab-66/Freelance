    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table id="filter" class="table table-striped table-bordered">
                ...
                @foreach($getbi as $each)
                    <tr>
                        <td>{{ $each->title}}</td>
                        <td>{{ $each->content }}</td>
                        <td>{{ $each->date }}</td>
                        <td> <a href="http://93.158.221.197/files/public/background_information/{{$each->bi_id}}/edit" title="Edit">
                                            <i class="fa fa-fw fa-pencil text-warning "></i> </a>
                                                                        <a href="http://93.158.221.197/files/public/background_information/{{$each->bi_id}}/delete" title="Delete">
