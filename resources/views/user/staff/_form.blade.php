    ...
    <div class="panel-body">
        ...
        <div class="form-group required {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
         ...
         <div class="form-group">
            {!! Form::label('county', trans('Country'), array('class' => 'control-label')) !!}
            <div class="controls">
            {!! Form::select('county', $countries, null, array('id'=>'county', 'class' => 'form-control select2')) !!}
                    
                <span class="help-block">{{ $errors->first('county', ':message') }}</span>
            </div>
        </div>
         <div class="form-group">
            {!! Form::label('city', trans('City'), array('class' => 'control-label')) !!}
            <div class="controls">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group">
                                <label>
                                    ...
                                    {{trans('staff.socialaccess')}} </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">&nbsp;</div>
