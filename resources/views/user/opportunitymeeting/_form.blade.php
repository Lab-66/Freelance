<div class="panel panel-primary">
    <div class="panel-body">
        @if (isset($meeting))
            {!! Form::model($meeting, array('url' => $type . '/' . $opportunity->id. '/' . $meeting->id, 'method' => 'put', 'files'=> true)) !!}
        @else
            {!! Form::open(array('url' => $type. '/' . $opportunity->id, 'method' => 'post', 'files'=> true)) !!}
        @endif
        ...
        <div class="form-group">
            <label>
                <input type="checkbox" value="1" name="all_day"
        ...
        <div class="form-group">
            <div class="controls">
                <a href="{{ url($type.'/'.$opportunity->id) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{trans('table.back')}}</a>
