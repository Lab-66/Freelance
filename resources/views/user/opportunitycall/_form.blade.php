<div class="panel panel-primary">
    <div class="panel-body">
        @if (isset($call))
            {!! Form::model($call, array('url' => $type . '/' . $opportunity->id . '/' . $call->id, 'method' => 'put', 'files'=> true)) !!}
        @else
        ...
        <div class="form-group required {{ $errors->has('date') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::text('date', isset($call)?null:date('d.m.Y.',strtotime("now")), array('class' => 'form-control date')) !!}
        ...
        <div class="form-group">
            <div class="controls">
                <a href="{{ url($type.'/'.$opportunity->id ) }}" class="btn btn-primary"><i
