        ...
        <div class="form-group">
            <div class="controls">
                @if (@$action == 'show')
                    ...
                    <a href="/files/public/sendByEmail?invice_id={{$invoiceReceivePayment->invoice->invoice_number}}" class="btn btn-primary"><i class="fa fa-envelope-o"></i>{{trans('Send Email')}}</a>
                @else
