...
<section>
    <div class="details clearfix">
        <div class="client left">
            <p>{{trans('quotation.quotation_to')}}</p>
            <p class="name">{{ is_null($quotation->customer)?"":$quotation->customer->full_name }}</p>
            <p> {{is_null($quotation->customer)?"":$quotation->customer->address}}</p>
            {{is_null($quotation->customer)?"":$quotation->customer->email}}
        </div>
        <div class="data right">
            <div class="title">{{trans('quotation.quotation_no')}} {{$quotation->quotations_number}}</div>
            <div class="date">
                {{trans('invoice.invoice_date')}}: {{ $quotation->invoice_date}}<br>
                {{trans('invoice.due_date')}}: {{ $quotation->due_date}}
            </div>
        </div>
    </div>
    <div class="container">
