...
class BackgroundinformationController extends UserController
{
    /**
                                ...
                                SalesOrderRepository $salesOrderRepository)
    {
        ...
        view()->share('type', 'background_information');
    }
    ...
    {
		$title = trans('Background Information');
		$getbi = DB::table('background_information')->get();
        return view('user.background_information.index', compact('title','getbi'));
    }
    ...
    {
        $title = trans('Background Information New');

        return view('user.background_information.create', compact('title'));
    }
    ...
    {
		DB::table('background_information')->insert([
									['title' => $_REQUEST['name'],
        ...
        return redirect("background_information");
    }
    ...
    {
		$rPorjects = DB::table('background_information')->where('bi_id','=',$id)->get();
		$id = $rPorjects[0]->bi_id;
		$name = $rPorjects[0]->title;
		$content = $rPorjects[0]->content;
		$date = $rPorjects[0]->date;


		$title = trans('background_information Edit');
 ...
 /*#####################################################################################################################
    ...
    {
		DB::table('background_information')
            ->where('bi_id', $id)
...
*/
    ...
    {
        DB::table('background_information')->where('bi_id', '=', $id)->delete();
		return redirect("background_information");
    }
