...
class SettingsController extends UserController
{
    ...
    public function index()
    {
		...
		$invoice_template = PrintTemplate::where('type','invoice')->lists('name','slug')->toArray();
		$saleorder_template = PrintTemplate::where('type','saleorder')->lists('name','slug')->toArray();
		$quotation_template = PrintTemplate::where('type','quotation')->lists('name','slug')->toArray();
    ...
    {
        //echo $request->file('site_logo_file');
		//die('yuyu');
