...
Route::get('agenda/create','Users\AgendaController@createAgenda');
Route::post('agenda/store','Users\AgendaController@store');
Route::get('agenda/data', 'Users\AgendaController@data');
Route::get('agenda/{id}/working', 'Users\AgendaController@working');
Route::get('agenda/{id}/done', 'Users\AgendaController@status');
...
Route::get('sync_eboekhouden', 'Users\SoapController@syncData');
Route::get('running_projects', 'Users\RunningProjectsController@index');
Route::get('running_projects', 'Users\RunningProjectsController@index');
Route::get('running_projects/create', 'Users\RunningProjectsController@create');
Route::post('running_projects/store', 'Users\RunningProjectsController@store');
Route::get('running_projects/{id}/edit', 'Users\RunningProjectsController@edit');
Route::post('running_projects/{id}/update', 'Users\RunningProjectsController@update');
Route::get('running_projects/{id}/delete', 'Users\RunningProjectsController@delete');
Route::get('sales_orders/prev_month', 'Users\SalesorderController@prevMonth');
Route::post('sales_orders/filtersales', 'Users\SalesorderController@filterPrev');
Route::get('notes', 'Users\NotesController@index');
Route::get('notes/create', 'Users\NotesController@create');
Route::post('notes/store', 'Users\NotesController@store');
Route::get('notes/{id}/edit', 'Users\NotesController@edit');
Route::post('notes/{id}/update', 'Users\NotesController@update');
Route::get('notes/{id}/delete', 'Users\NotesController@delete');

Route::get('background_information', 'Users\BackgroundinformationController@index');
Route::get('background_information/create', 'Users\BackgroundinformationController@create');
Route::post('background_information/store', 'Users\BackgroundinformationController@store');
Route::get('background_information/{id}/edit', 'Users\BackgroundinformationController@edit');
Route::post('background_information/{id}/update', 'Users\BackgroundinformationController@update');
Route::get('background_information/{id}/delete', 'Users\BackgroundinformationController@delete');
//Route::get('events_php','Users\AgendaController@eventsPhp');
...
Route::group(array('middleware' => ['sentinel', 'authorized', 'xss_protection'], 'namespace' => 'Users'), function () {
	...
	Route::get('email_template/create', 'MailboxController@create');
